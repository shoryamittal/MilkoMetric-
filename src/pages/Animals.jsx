...
export default function Animals() {
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-col gap-3 rounded-lg border border-line bg-canvas-raised p-3.5 shadow-card sm:flex-row sm:flex-wrap sm:items-center">
        <div className="relative flex-1 min-w-[180px]">
          ...
          <input
            ...
            className="w-full rounded-sm border border-line bg-canvas py-2 pl-8 pr-3 text-[13px] text-ink placeholder:text-ink-faint focus:border-pasture-500"
          />
        </div>
        ...
        <div className="flex items-center gap-1.5 sm:ml-auto">
          <ArrowUpDown size={13} className="text-ink-faint" />
      ...
      {filtered.length === 0 ? (
        ...
        <div className="overflow-x-auto rounded-lg border border-line bg-canvas-raised shadow-card">
